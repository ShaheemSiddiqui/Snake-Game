...
namespace Snake
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int direction = right;
            Random randomNumbersGenerator = new Random();  //Using Random Numbers
            Console.BufferHeight = Console.WindowHeight;
            lastFoodTime = Environment.TickCount;

            List<Position> obstacles = new List<Position>()    // Creating Obstacles in random spots
            {
                new Position(randomNumbersGenerator.Next(30), randomNumbersGenerator.Next(30)),
                new Position(randomNumbersGenerator.Next(30), randomNumbersGenerator.Next(30)),
                new Position(randomNumbersGenerator.Next(30), randomNumbersGenerator.Next(30)),
                new Position(randomNumbersGenerator.Next(30), randomNumbersGenerator.Next(30)),
                new Position(randomNumbersGenerator.Next(30), randomNumbersGenerator.Next(30)),
            ...
            while (true)
            {
                ...
                sleepTime -= 0.01;  // movement speed
                Thread.Sleep((int)sleepTime);  // movement speed
            }
        }
    }
}
